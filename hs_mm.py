...
# Ações
tickers_acoes = ['^GSPC', '^IXIC', '^RUT', '^N225', '^FTSE', '^STOXX50E', '^GDAXI', '^BVSP', '^AXJO', '^MXX', '000001.SS', '^HSI', '^NSEI', 'FTSEMIB.MI', '^FCHI', 'ARGT']
df_acoes = get_data(tickers_acoes).fillna(method='ffill', axis=0)
names_acoes = ['S&P 500', 'Nasdaq', 'Russel 2000', 'Nikkei', 'FTSE', 'Euro Stoxx', 'DAX', 'Ibovespa', 'S&P ASX', 'BMV', 'Shanghai', 'Hang Seng', 'NSE', 'FTSE MIB', 'CAC', 'Merval USD']
...
if selected == 'Market Monitor':
    ...
    def market_return(df, classe):
        ...
        daily_diff = df.ffill().diff(1)
        daily_diff = daily_diff.fillna(0).iloc[-1]
        ...
        for instrument in tickers_order:
...
if selected == 'Technical Analysis':
    ...
    tickers_asx = [
    'CQE.AX', 'QBE.AX', 'ALX.AX', 'BKW.AX', 'WEB.AX', 'PNI.AX', 'BOQ.AX', 'ORA.AX',
    'GNC.AX', 'WTC.AX', 'WES.AX', 'RRL.AX', 'EDV.AX', 'BPT.AX', 'NEC.AX', 'EVT.AX',
    'FLT.AX', 'RMD.AX', 'MPL.AX', 'LIC.AX', 'A2M.AX', 'NSR.AX', 'KLS.AX', 'LTM.AX',
    'CPU.AX', 'REA.AX', 'SOL.AX', 'EMR.AX', 'ANN.AX', 'WDS.AX', 'JBH.AX', 'TNE.AX',
    'GOR.AX', 'EVN.AX', 'IFL.AX', 'DEG.AX', 'RMS.AX', 'SUL.AX', 'BGA.AX', 'SIQ.AX',
    'GPT.AX', 'DTL.AX', 'CLW.AX', 'CRN.AX', 'JHX.AX', 'SFR.AX', 'FPH.AX', 'HLS.AX',
    'CNI.AX', 'PNV.AX', 'HMC.AX', 'PMV.AX', 'KAR.AX', 'TLX.AX', 'PRU.AX', 'NAN.AX',
    'NXT.AX', 'CXO.AX', 'PXA.AX', 'CAR.AX', 'DMP.AX', 'CWY.AX', 'SEK.AX', 'NST.AX',
    'CHC.AX', 'XRO.AX', 'COL.AX', 'NHF.AX', 'MIN.AX', 'SCG.AX', 'VEA.AX', 'SYA.AX',
    'QUB.AX', 'TLC.AX', 'BHP.AX', 'NAB.AX', 'WBC.AX', 'NWH.AX', 'ORG.AX', 'ALD.AX',
    'AUB.AX', 'REH.AX', 'CBA.AX', 'RIO.AX', 'HVN.AX', 'ORI.AX', 'SDF.AX', 'LLC.AX',
    'NWS.AX', 'SUN.AX', 'STO.AX', 'CCP.AX', 'IRE.AX', 'SGM.AX', 'ILU.AX', 'WOW.AX',
    'PDN.AX', 'SHL.AX', 'RHC.AX', 'CSL.AX', 'LYC.AX', 'GMD.AX', 'MTS.AX', 'SVW.AX',
    'BEN.AX', 'CQR.AX', 'TAH.AX', 'IAG.AX', 'FMG.AX', 'COH.AX', 'MQG.AX', 'ASX.AX',
    'BWP.AX', 'AMP.AX', 'HLI.AX', 'MGR.AX', 'RGN.AX', 'WAF.AX', 'WHC.AX', 'WOR.AX',
    'IPL.AX', 'CMM.AX', 'GMG.AX', 'AGL.AX', 'SGR.AX', 'BOE.AX', 'AIA.AX', 'BSL.AX',
    'PME.AX', 'ALL.AX', 'IEL.AX', 'S32.AX', 'NUF.AX', 'INA.AX', 'LNW.AX', 'ELD.AX',
    'CTD.AX', 'PPT.AX', 'CGF.AX', 'SGP.AX', 'JLG.AX', 'VCX.AX', 'RWC.AX', 'NEU.AX',
    'IPH.AX', 'CNU.AX', 'NWL.AX', 'VUK.AX', 'AMC.AX', 'LOV.AX', 'BGL.AX', 'LTR.AX',
    'VNT.AX', 'APA.AX', 'ALQ.AX', 'APE.AX', 'MP1.AX', 'MFG.AX', 'ARB.AX', 'HDN.AX',
    'TPG.AX', 'MND.AX', 'QAN.AX', 'CIA.AX', 'PLS.AX', 'HUB.AX', 'BRG.AX', 'TCL.AX',
    'TLS.AX', 'NHC.AX', 'SQ2.AX', 'NIC.AX', 'BXB.AX', 'CKF.AX', 'AZJ.AX', '360.AX',
    'CHN.AX', 'IGO.AX', 'DXS.AX', 'DRR.AX', 'ARF.AX', 'CIP.AX', 'BAP.AX', 'NEM.AX',
    'ING.AX', 'FBU.AX', 'DHG.AX', 'ANZ.AX', 'DOW.AX', 'TWE.AX', 'SPK.AX', 'WBT.AX'
]

    tickers_dax = [
    "BAS.DE", "BAYN.DE", "ALV.DE", "ADS.DE", "SIE.DE", "DBK.DE", "CON.DE",
    "DPW.DE", "MBG.DE", "P911.DE", "HEN3.DE", "CBK.DE", "DB1.DE", "BMW.DE",
    "DTE.DE", "MRK.DE", "IFX.DE", "MUV2.DE", "SAP.DE", "RHM.DE", "BEI.DE",
    "FRE.DE", "HNR1.DE", "RWE.DE", "MTX.DE", "SY1.DE", "HEI.DE", "QIA.DE",
    "EOAN.DE", "BNR.DE", "SRT3.DE", "VOW3.DE", "VNA.DE", "ZAL.DE", "1COV.DE",
    "AIR.DE", "SHL.DE", "ENR.DE", "DTG.DE", "P911.DE"
]
    ...
    tickers_nikkei = ["4151.T", "4502.T", "4503.T", "4506.T", "4507.T", "4519.T", "4523.T", "4568.T",
    "4578.T", "6479.T", "6501.T", "6503.T", "6504.T", "6506.T", "6526.T", "6594.T",
