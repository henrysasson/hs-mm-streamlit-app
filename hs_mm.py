...
df_moedas = get_data(tickers_moedas).fillna(method='ffill', inplace = True)
...
df_commodities = get_data(tickers_commodities).fillna(method='ffill', inplace = True)
...
df_rf = get_data(tickers_rf).fillna(method='ffill', inplace = True)
...
df_crypto = get_data(tickers_crypto).fillna(method='ffill', inplace = True)
